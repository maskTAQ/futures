  ...
  return (
    <Text
      style={[
        styles.text,
        textStyle,
        disabled ? Object.assign(styles.disabledText, disabledTextStyle) : null
      ]}
    >
      {children}
    </Text>
...
const CreatedWrapper = feedback => feedback ? TouchableOpacity : ({ onPress, disabled, ...props }) => <TouchableWithoutFeedback {...{ onPress, disabled }}><View {...props}></View></TouchableWithoutFeedback>;
const Button = ({
  children,
  style,
  onPress,
...
Button.propTypes = {
  ...
  disabledButtonStyle: PropTypes.oneOfType([PropTypes.object, PropTypes.array]),
